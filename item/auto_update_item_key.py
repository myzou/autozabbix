...
#日志文件
log=log.LOG("auto_update_item_key")

#配置文件
list_file="../list/auto_update_item_key.txt"

#监控项的设置
key="findsec.test"
new_key="findsec.test.new"
    ...
    for line in f.readlines():
        ...
        if zabbix.host_exists(host_ip):
            ...
            if zabbix.item_exits(host_ip, key):
                ...
                zabbix.update_item_key(itemid[0],new_key)
                log.info("主机%s监控项%s已更新为%s" % (host_ip,key,new_key))
            else:
